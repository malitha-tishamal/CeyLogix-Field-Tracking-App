...
class FactoryOwnerDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // -------------------------------------------------------------
      // 🔵 NOW USING YOUR CUSTOM DRAWER (FactoryOwnerDrawer)
      // -------------------------------------------------------------
  ...
  Widget _buildKeyMetrics(BuildContext context) {
    return GridView.count(
      ...
      children: [
        ...
        _buildMetricCard(context, 'Pending Exports', '8 Orders', Icons.flight_takeoff, AppColors.accentRed),
      ],
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(value, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.darkText)),
                Text(title, style: TextStyle(fontSize: 12, color: AppColors.darkText.withOpacity(0.7))),
              ],
            ),
          ],
        ),

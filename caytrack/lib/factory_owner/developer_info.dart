...
class _DeveloperInfoPageState extends State<DeveloperInfoPage> {
  ...
  Future<void> _launchPhone(String phoneNumber) async {
    ...
    // Clean the phone number and format for tel: scheme
          ...
          children: [
            Row(
              ...
              children: [
                ...
                IconButton(
                  icon: const Icon(Icons.code, color: AppColors.headerTextDark, size: 28),
                  onPressed: () {},
                ),
              ],
            ),
...
class DeveloperInfoContent extends StatelessWidget {
  // Callbacks to access URL/Email/Phone launching functions from the State object
  ...
  // --- Social Media Widgets: Font Awesome Icons and Links ---
...
SocialMediaItem(
  icon: Icons.camera_alt, // Instagram (closest built-in)
  label: 'Instagram',
  url: 'https://instagram.com/malithatishamal',
  color: const Color.fromARGB(255, 235, 18, 192),
),
SocialMediaItem(
  icon: Icons.code, // GitHub (represents coding/projects)
  label: 'GitHub',
  url: 'https://github.com/malithatishamal',
  color: const Color(0xFF24292E),
),
SocialMediaItem(
  icon: Icons.business, // LinkedIn (represents professional)
  label: 'LinkedIn',
  url: 'https://linkedin.com/in/malithatishamal',
  color: const Color(0xFF0A66C2),
),
SocialMediaItem(
  icon: Icons.flutter_dash, // Twitter / Tech / Flutter-themed
  label: 'Twitter',
  url: 'https://twitter.com/malithatishamal',
  color: const Color(0xFF1DA1F2),
),
SocialMediaItem(
  icon: Icons.language, // Portfolio / Email
  label: 'Portfolio',

...
class FactoryOwnerRegistrationPage extends StatefulWidget {
// Hardcoded role for this specific page
final String role = 'Factory owner';
const FactoryOwnerRegistrationPage({super.key});

@override
State<FactoryOwnerRegistrationPage> createState() => _FactoryOwnerRegistrationPageState();
}

class _FactoryOwnerRegistrationPageState extends State<FactoryOwnerRegistrationPage> {
